...
//   const { transactions, summary, isLoading, loadData } =
//     useTransaction({ userId: user?.id });
...
//             <Text className="text-text">Balance: ${Number(summary.balance || 0).toFixed(2)}</Text>
//             <Text className="text-income">Income: ${Number(summary.income || 0).toFixed(2)}</Text>
//             <Text className="text-expense">Expenses: ${Math.abs(Number(summary.expences || 0)).toFixed(2)}</Text>
...
//                 <View key={t.id || index} className="bg-card p-3 rounded-lg mb-2 border border-border">
//                   <Text className="text-text font-semibold">{t.title}</Text>
//                   <Text className={t.amount >= 0 ? "text-income" : "text-expense"}>
